  ...
  return (
    <Callout>
      <p>
        ...
        When an animal’s attempts to escape aversive events are blocked, they
        tend to give up trying even when their power to escape is restored. This
        phenomenon, called learned helplessness, has been replicated with a wide
        variety of animal species (e.g., dogs, cats, monkeys, cockroaches,
        children, adult humans) <em>Friedman, S. G. (2018).</em>
      </p>
    </Callout>
  );
};
